        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Airbnb.org: disaster relief', 'Support Afghan refugees', 'Combating discrimination'].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-gray-600 hover:underline">{item}</a>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Try hosting', 'AirCover for Hosts', 'Explore hosting resources', 'Visit our community forum'].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-gray-600 hover:underline">{item}</a>
                  </li>
                ))}
